...
namespace GoodSamaritan.Controllers
{
    ...
    public class PoliceReportedsController : Controller
    {
        ...
        {
            return View(await db.PoliceReported.ToListAsync());
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "PoliceReportedId,Value")] PoliceReported policeReported)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "PoliceReportedId,Value")] PoliceReported policeReported)
        {
            if (ModelState.IsValid)
            {
